...
const Cta = () => {
    return (
        ...
        <div className='px-6 py-12 sm:px-6 sm:py-12 lg:px-8'>
            ...
            <h2 className='text-3xl font-times font-semibold tracking-tight text-slate-100 sm:text-4xl'>Descubra seu poder interior!</h2>
            <p className='mx-auto mt-3 max-w-xl font-times text-lg leading-8 text-slate-100'>Venha descobrir o poder da sua mente e encontrar equilíbrio em uma consulta que pode transformar a sua vida.</p>
