...
const Sobre1 = () => {
    return (
        ...
        <div class="bg-[#d7a493] pb-20 sm:pb-24 xl:pb-0">
            ...
            <div class="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-2/4 xl:flex-none">
                <div class="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
                <StaticImage class="absolute inset-0 h-full w-full rounded-2xl object-cover shadow-2xl" src="../images\fotomulhercelular.jpg" alt=""/>
                </div>
            </div>
            <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                <figure class="relative isolate pt-6 sm:pt-12">
                <svg viewBox="0 0 162 128" fill="none" aria-hidden="true" class="absolute mt-8 left-0 top-0 -z-10 h-20 stroke-white/20">
                ...
                <div class="-mt-20 text-base">
                    <div class="font-semibold text-white">Sobre mim</div>
                    <div class="mt-1 text-[#c96572] font-semibold">Jullia Andreazza - CRP-xx/xxxxx</div>
                </div>
                <blockquote class="mt-5 text-xl leading-8 text-white sm:text-1xl sm:leading-9">
