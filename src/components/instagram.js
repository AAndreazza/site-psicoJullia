    ...
    return (
        ...
        <h2 className='text-xl text-center font-light mt-4 leading-8 tracking-tight text-[#065f46]'>Acompanhe meu trabalho nas redes sociais</h2>
            ...
            <div className='group relative'>
                <Link to='https://www.instagram.com/p/C1zdDkyrNYM/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA=='>
            ...
            <div className='group relative'>
                <Link to='https://www.instagram.com/p/C1t-1g9uhIr/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA=='>
                    <div className='aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md lg:aspect-none group-hover:opacity-75 lg:h-80'>
            ...
            <div className='group relative'>
                <Link to='https://www.instagram.com/p/CxdnL7COEO2/?utm_source=ig_web_copy_link'>
                    <div className='aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md lg:aspect-none group-hover:opacity-75 lg:h-80'>
            ...
            <div className='group relative'>
                <Link to='https://www.instagram.com/p/C2C3ST3r_OC/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA=='>
                    <div className='aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md lg:aspect-none group-hover:opacity-75 lg:h-80'>
