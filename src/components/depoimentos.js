...
const Depoimentos = () => {
    return (
        <div className='relative isolate bg-[#fff9f9] pb-32 pt-24 sm:pt-14'>
        ...
        <div className='absolute inset-x-0 top-0 -z-10 flex transform-gpu overflow-hidden pt-32 opacity-25 blur-3xl sm:pt-40 xl:justify-end' aria-hidden='true'>
            <div className='ml-[-22rem] aspect-[1313/771] w-[82.0625rem] flex-none origin-top-right rotate-[30deg] bg-gradient-to-tr from-[#fff9f9] to-[#c99696] xl:ml-0 xl:mr-[calc(50%-12rem)]'></div>
        </div>
        <div className='mx-auto max-w-7xl px-6 lg:px-8' id='depoimentos'>
            ...
            <figure className='col-span-2 hidden sm:block sm:rounded-2xl sm:bg-[#fff9f9] sm:shadow-lg sm:ring-1 sm:ring-gray-900/5 xl:col-start-2 xl:row-end-1'>
            ...
            <div className='space-y-8 xl:contents xl:space-y-0'>
                ...
                <figure className='rounded-2xl bg-[#fff9f9] p-6 shadow-lg ring-1 ring-gray-900/5'>
