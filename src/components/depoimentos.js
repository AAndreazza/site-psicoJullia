...
const Depoimentos = () => {
    return (
        <div class="relative isolate bg-[#fff9f9] pb-32 pt-24 sm:pt-14">
        <div class="absolute inset-x-0 top-1/2 -z-10 -translate-y-1/2 transform-gpu overflow-hidden opacity-30 blur-3xl" aria-hidden="true">
            <div class="ml-[max(50%,38rem)] aspect-[1313/771] w-[82.0625rem] bg-gradient-to-tr from-[#f9fbff] to-[#c99696]"></div>
        </div>
        <div class="absolute inset-x-0 top-0 -z-10 flex transform-gpu overflow-hidden pt-32 opacity-25 blur-3xl sm:pt-40 xl:justify-end" aria-hidden="true">
            <div class="ml-[-22rem] aspect-[1313/771] w-[82.0625rem] flex-none origin-top-right rotate-[30deg] bg-gradient-to-tr from-[#fff9f9] to-[#c99696] xl:ml-0 xl:mr-[calc(50%-12rem)]"></div>
        </div>
        <div class="mx-auto max-w-7xl px-6 lg:px-8" id='depoimentos'>
            <div class="mx-auto max-w-xl text-center">
            <h2 class="text-2xl font-semibold leading-8 tracking-tight text-[#b37e6c]">Depoimentos</h2>
            </div>
            <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-gray-900 sm:mt-14 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
            <figure class="col-span-2 hidden sm:block sm:rounded-2xl sm:bg-[#fff9f9] sm:shadow-lg sm:ring-1 sm:ring-gray-900/5 xl:col-start-2 xl:row-end-1">
            ...
            <div class="space-y-8 xl:contents xl:space-y-0">
                ...
                <figure class="rounded-2xl bg-[#fff9f9] p-6 shadow-lg ring-1 ring-gray-900/5">
                    ...
                    <div>
                        <div class="font-semibold">I.S, 24 anos</div>
                    </div>
                    </figcaption>
                </figure>
                ...
                <figure class="rounded-2xl bg-[#fff9f9] p-6 shadow-lg ring-1 ring-gray-900/5">
                    ...
                    <figcaption class="mt-6 flex items-center gap-x-4">
                    <div>
                        <div class="font-semibold">G.O - 38 anos</div>
                    </div>
                    </figcaption>
                </figure>
                ...
                <figure class="rounded-2xl bg-[#fff9f9] p-6 shadow-lg ring-1 ring-gray-900/5">
                    ...
                    <figcaption class="mt-6 flex items-center gap-x-4">
                    <div>
                        <div class="font-semibold">L.C - 45 anos</div>
                    </div>
                    </figcaption>
                </figure>
            ...
            <div class="space-y-8 xl:contents xl:space-y-0">
                ...
                <figure class="rounded-2xl bg-[#fff9f9] p-6 shadow-lg ring-1 ring-gray-900/5">
                    ...
                    <figcaption class="mt-6 flex items-center gap-x-4">
                    <div>
                        <div class="font-semibold">M.A - 48 anos</div>
                    </div>
                    </figcaption>
                </figure>
                ...
                <figure class="rounded-2xl bg-[#fff9f9] p-6 shadow-lg ring-1 ring-gray-900/5">
                    ...
                    <figcaption class="mt-6 flex items-center gap-x-4">
                    <div>
                        <div class="font-semibold">S.R - 61 anos</div>
                    </div>
                    </figcaption>
                </figure>
                ...
                <figure class="rounded-2xl bg-[#fff9f9] p-6 shadow-lg ring-1 ring-gray-900/5">
                    ...
                    <figcaption class="mt-6 flex items-center gap-x-4">
                    <div>
                        <div class="font-semibold">G.F - 34 anos</div>
                    </div>
                    </figcaption>
                </figure>
