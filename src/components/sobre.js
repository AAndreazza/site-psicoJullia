...
const Sobre = () => {
    return (
        ...
        <div className='relative bg-[#d7a493] mx-36 mt-36 mb-4 rounded-lg'>
        ...
        <div className='relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40'>
            ...
            <div className='mt-8'>
                <a href='#' className='inline-flex rounded-md bg-[#c96572] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#aa757c96] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white'>Saiba mais</a>
            </div>
            </div>
        </div>
        </div>
