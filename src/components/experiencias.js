...
const Experiencias = () => {
    return (
        ...
        <div className='px-6 py-12 sm:px-6 sm:py-12 lg:px-8'>
            ...
            <p className='mx-auto mt-4 lg:px-0 px-5 max-w-xl font-light text-lg leading-8 text-slate-100 whitespace-pre-wrap'>Ansiedade    Aposentadoria    Autoconhecimento    Burnout    Demências    Depressão    Diagnóstico Diferencial    Fobias    Gestão de Pessoas    Liderança    Luto    Relacionamentos   Transtorno Bipolar     <br/>Transtorno de Ansiedade Generalizada (TAG)    Transtorno de Pânico    Transtorno de Déficit de Atenção e Hiperatividade (TDAH)    <br/>Transtorno de Estresse Pós-Traumático    Compulsão Alimentar</p>
