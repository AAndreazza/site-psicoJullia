            ...
            <div className='mx-auto -mt-4 lg:mt-16 mb-10 max-w-7xl px-6 lg:px-8'>
                ...
                <div className='mt-12 grid grid-cols-1 gap-y-16 sm:grid-cols-1 lg:grid-cols-2'>
                    ...
                    <div className='bg-fundoEspecifico+ lg:ml-48 -mb-8 lg:mb-8 rounded-lg lg:l-12 lg:w-96 mx-auto'>
                        ...
                        <dd className='mx-4 my-5 text-center font-light text-slate-100 px-2'>Avaliação psicológica para cirurgia bariátrica; cirurgia para realização de vasectomia; cirurgia para realização de laqueadura ou histerectomia. Acompanhamento psicológico pré e <br/> pós-operatório.</dd>
                    </div>
