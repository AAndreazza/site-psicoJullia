...
const Servicos = () => {
    return (
        <div className="bg-[#fff9f9]">
            <div className="mx-auto mt-28 max-w-7xl px-6 sm:mt-22 lg:px-8">
                
                    <h2 className="text-3xl text-center font-bold font-cambria tracking-tight text-gray-900 sm:text-2xl">SERVIÇOS</h2>
